...
<div class="content">
    ...
    <?php if ($data['Quantity'] != 0 && $role === 1): ?>
        <div class="btn" style="background: #007bff; color: white;" onclick="openVirtualModal()">
    ...
    <?php endif; ?>
    <a href="../Config/exportAction.php?id=<?= $id ?>&type=inventory" class="btn" style="background: #28a745; color: white;">
    ...
    <?php else: ?>
        ...
        <div id="pageHeadText" style="border-radius: 25px 25px 0 0;">
            ...
            <span class="message-label" style="font-size:10px; margin: -2.5% 0 0 85%;">250 maximum characters </span>
    ...
    <span class="message-label" style="font-size:10px; margin: -2.5% 0 0 85%;">250 maximum characters </span>    
        ...
        <div class="status-section" id="pageHeadText" style="border-radius: 0 0 25px 25px; z-index: 0;">
    ...
    <?php if ($mode === 'ticketing'): ?>
        ...
        <div class="actions" style="margin-right: 3%;">
            <?php if ($role === 1 && $data['Status'] === 'Resolved' && $mode === 'ticketing' && empty($data['issued_item_name'])): ?>
                <form method="POST" action="../Config/updateAction.php" onsubmit="submitEditForm(this)">
                    ...
                    <div class="admin-inventory-control"
                        style="background: #fff3cd; padding: 18px; border-left: 5px solid #ffc107; margin: -16% -17% 16% 0; border-radius: 0 25px 25px 0;">
                        <p style="font-size: 0.8rem; font-weight: bold; margin-bottom: 5px;">
                            <i class="fas fa-shield-alt"></i> ADMIN: ISSUE ASSETS
                        </p>
                        <select name="issued_item_id" class="value" style="width: 99%; margin: 0 -40px 5px 0;"
                            onfocus="stopRefresh()">
            ...
            <button type="button" class="btn download" style="width:17.5%; z-index:9999;" onclick="exportTicketToDoc('pdf')">
