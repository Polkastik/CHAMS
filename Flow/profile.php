...
<body>
    ...
    <script>
        ...
        const months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]; // if NKTI wants monthly
        const labels = rawData.map(d => months[d.month - 1]); // change this to const labels = rawData.map(d => monthNames[d.month - 1]); if u want monthly
        ...
        new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: 'Monthly Resolved Tickets',
                    data: values,
                    fill: false,
                    tension: 0.3
                }]
