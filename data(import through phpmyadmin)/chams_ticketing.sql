...
(29, 'TICKET-43F9A5', 'test dash', 'test dash', NULL, 5, NULL, 'Unlabeled', 'Resolved', 4, 2, 2, NULL, 1, '2026-04-30 13:45:02', NULL, '2026-04-30 16:33:00', '2026-04-30 16:33:00'),
...
(36, 'TICKET-A495D9', 'asd', 'asd', NULL, 5, NULL, 'High', 'Resolved', 3, 2, 4, NULL, 1, '2026-04-30 19:29:08', '2026-05-07 22:10:00', '2026-05-08 22:17:41', '2026-05-08 22:17:46'),
(37, 'TICKET-6DA9CC', 'test', 'test', NULL, 4, NULL, 'High', 'Resolved', 3, 2, 4, NULL, 1, '2026-05-05 19:28:00', '2026-05-07 18:54:00', '2026-05-11 11:16:21', '2026-05-11 11:16:21'),
...
(44, 'TICKET-B7D3BC', '', '20 005', NULL, 5, NULL, 'Unlabeled', 'Resolved', 3, 2, 4, 6, 300, '2026-05-11 23:03:48', NULL, '2026-05-11 23:55:26', '2026-05-11 23:55:26'),
(45, 'TICKET-22654F', '', 'test', NULL, 4, 7, 'Unlabeled', 'Ongoing', 3, 2, 4, NULL, 1, '2026-05-12 00:05:14', NULL, '2026-05-12 23:49:10', NULL);
...
--
ALTER TABLE `ticket_subcategories`
  ADD CONSTRAINT `ticket_subcategories_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `ticket_categories` (`TC_ID`);
COMMIT;
